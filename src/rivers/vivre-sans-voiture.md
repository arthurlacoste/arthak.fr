...
updated: 2026-07-13
layout: rivers
slug: living-without-a-car
title: Living without a car
subtitle: An essay on alternatives to cars
archive: true
categories:
  - Essay
  - Mobility
...
translation: English translation of the French manuscript
---
...
* concepts which would still seem vague to you after reading them,
* anecdotes out of context (even if they are almost all authentic),
* other points which are emphasized too much in your opinion,
* and the structure of the document itself (chapter breakdown),
* spelling errors (my proofreader tells me there are more than 300, but he seems out of breath).

Do not hesitate to suggest possible changes by coming to discuss them in the dedicated space, in [the project's Git repository](https://github.com/arthurlacoste/vivre-sans-voiture/issues)[^1].
...
If you are a driver at heart or speed is important to you, this book may not be for you. This work essentially highlights active modes[^2], because they represent a concrete and rational alternative. However, in recent years, electric versions of cars and motorcycles have been released, and could match your thirst for thrills.
...
[^2]: Active modes are non-motorized means of transport. [See the glossary](#active-modes)
...
Coming from generation Y, I was born with a mouse in my hands. Raised on the Game Boy, I was already writing short stories with my little sister when I was 12 years old. After writing a few plays for the troupes in which I performed, I continued writing, writing numerous articles[^3] on the internet.  
...
[^3]: See my blog [irz.fr](https://irz.fr)
...
[^2-6]: Fressoz J.-B., Bonneuil C., (2013). “The Anthropocene event, the Earth, history and us”
[^2-3]: Huxley A., (1931). “Brave New World”
...
* A disruption of the ecosystem, with many species on the verge of extinction. I know, you may be thinking that as long as the species in question isn't humans, it doesn't matter. But it's not just that.
* Weather phenomena such as extreme heat waves and dry soils. You may already be concerned here. Imagine, you have the wrong day, you forget your life-saving bottle of water. Yes, our life hangs by a thread.
...
No more questionable jokes! He is also a very good example of intermodality: he combines bicycle and train to get to work every day of the week. This is what lies behind the word intermodality: using and mixing several means of transport for a single trip. And somewhere, we can say that we are all _a little_ intermodal. Even when you get off the tram, or have just parked your car: you always take at least a few steps with your feet.
...
* If you have a license, you can rent a utility vehicle for the day for a few dozen euros.
*If you do not have a license, you can ask a friend to help you with your move by driving your rental.
* If you don't have a friend (it's sad, but it happens), you can call on a moving service, which takes care of transporting all your belongings from point A to point B. The service even includes the packaging of your goods according to contracts.
...
Regarding reservations, I suggest you try the Trainline[^5-6] service (formerly Captain Train), which offers an ergonomic and very well thought-out interface for your online ticket purchases. Applications are of course available for smartphones.
...
“This horse of wood and steel fills a void in modern existence; it not only responds to needs, but to aspirations. » [^5-7]
...
The question of decline is addressed in the chapter *[An economic question](#an-economic-question)*.
...
- Radio-Canada Info, (01/09/2015). “[Copenhagen: Cycling Paradise](https://www.youtube.com/watch?v=7qxv3DwqZsA)”

#### Books and studies
- Bergeron R., (1999). “The Black Book of the Automobile”
- Weiss E., (2010). “Bike Snob: Chronicles of a Bike Madman”
